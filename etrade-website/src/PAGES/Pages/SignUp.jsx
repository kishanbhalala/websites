      ...
      <div className="photo-section">
        <div className=" flex items-center justify-between  px-[100px] py-[40px] ">
          ...
          <div className="flex items-center">
            <p className="text-[#292930] text-sm font-medium">
              Already a member?
            </p>
            <Link
              to="/SignIn"
              href="#"
              className=" relative px-10 py-5 rounded-md font-semibold ml-10 text-white bg-[#ff497c] 
                        before:absolute 
                        before:content-[''] 
                        before:w-[130px] 
                        before:rounded-md 
        ...
        <div className="absolute top-0 -z-10">
          <img
            className="h-[800px] "
            src="../src/assets/pages/sign up/asset 1.jpeg"
            alt=""
          />
          <div className="absolute top-20 pl-[100px]">
            <p className="text-[#292930] font-bold text-3xl mt-16 w-72">
          ...
          <form className="h-20">
            ...
            <div className="relative text-gray-500  mt-14">
              ...
              <input
                ...
                className="border border-gray-300 w-[400px] px-9 py-5 rounded-md font-normal focus:outline-blue-400"
              />
            </div>
            <div className="relative text-gray-500  mt-14">
              <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">

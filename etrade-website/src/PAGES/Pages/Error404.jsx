          ...
          <div className="flex items-center">
            <div className="pr-[100px]">
              <div className="flex mb-2">
                ...
                <h1 className="flex items-center text-[#FF497C] text-sm font-bold ml-2">
                  Oops! Somthing's missing.
                </h1>
              </div>
              <h1 className="text-5xl font-bold text-[#27272E] mb-10">
                Page not found
              </h1>
              ...
              <div className="mt-14">
                <Link
                  to="/"
                  href="#"
                  className=" relative px-12 py-5 rounded-md font-semibold  text-white bg-[#FF497C]
                        before:absolute 
                        before:content-[''] 
                        before:w-[220px] 
                        before:rounded-md 
            ...
            <div className="bg-cover">
              <img
                className=""
                src="../src/assets/pages/error/asset 2.png"
                alt=""
              />
            </div>
          </div>

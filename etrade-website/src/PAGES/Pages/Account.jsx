  ...
  return (
    <>
      <div>
        ...
        <section className="PAGES-DETAILS-PART px-24 py-[100px]">
          <div className="mb-10">
            <img
              className="rounded-full mb-3"
              src="../src/assets/pages/account/asset 3.png"
              alt=""
            />
            <h1 className="text-[#292930] font-bold text-lg mb-1">
              Hello Annie{" "}
            </h1>
          ...
          <div className="grid grid-cols-4 gap-20">
            <div className="LEFT-PART ">
              <div className=" border rounded-md p-10">
                <div
                  ...
                  className={`${
                    activeTab === 1
                      ? "bg-[#F6F7FB] rounded-md mb-2 cursor-pointer flex items-center text-2xl text-[#3577F0] h-12 px-6"
                ...
                <div className="text-gray-500 hover:bg-[#F6F7FB] rounded-md cursor-pointer duration-300">
                  <Link
                    to="/SignIn"
                    className="flex items-center text-xl hover:text-[#3577F0] h-12 px-6 duration-300"
                    href=""
                  >
                    <i class="ri-logout-box-r-line"></i>
                    <span className="text-sm font-semibold ml-4">Logout</span>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="RIGHT-PART col-span-3 ">
              {activeTab === 1 && (
                <div className="DASHBOARD-DETAILS animate-blink">
                  <h1 className="text-lg mb-10">
                    Hello Annie (not{" "}
                    <span className="text-xl font-semibold">Annie?</span>{" "}
                    <Link
                      to="/SignIn"
                      className="text-[#E76458] hover:text-[#3577F0] cursor-pointer duration-300"
                    >
                      Log Out
                    </Link>{" "}
                    )
              ...
              {activeTab === 2 && (
                <div className="ORDERS-DETAILS animate-blink">
                  <div className="py-5 px-7 flex items-center bg-[#F6F7FB] text-[#292930] rounded-md">
                    ...
                    <h1 className="text-xl font-semibold w-96 text-right ">
                      Actions
                    </h1>
                  </div>
              ...
              {activeTab === 3 && (
                <div className="DOWNLOAD-DETAILS animate-blink">
              ...
              {activeTab === 4 && (
                <div className="ADDRESSES-DETAILS animate-blink">
                  <h1 className="text-sm text-gray-800 mb-8">
              ...
              {activeTab === 5 && (
                <div className="ACCOUNT-DETAILS w-[70%] animate-blink">
                  ...
                  <div className="relative text-gray-500 mb-8">
                    ...
                    <h1 className="text-xs mt-3 mb-10">
                      This will be how your name will be displayed in the
                      account section and in reviews
                    </h1>
                  </div>
                  <div>
                    <h1 className="text-2xl font-semibold text-[#292930] mb-10">
                      Password Change
                    </h1>
                    <div className="relative text-gray-500  mb-8">
                      <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                      ...
                      <input
                        type="password"
                        className="w-full  border border-gray-300  px-10 py-5 rounded-md font-normal outline-none placeholder:text-gray-700 "
                        placeholder="****************"
                      />
                    </div>
                  </div>

...
const Cart = () => {
  ...
  let amount =
    cartData.length &&
    cartData.map((item) => item.rate).reduce((prev, next) => prev + next);
  let Total = amount + 8;
          ...
          <div className="px-24 my-[100px] ">
            <div className="flex justify-between items-center">
              ...
              <h1
                ...
                className="text-sm  text-[#3577F0] cursor-pointer"
              >
                Clear Shoping Cart
              </h1>
            </div>
                        ...
                        <div className="flex justify-between py-4 items-center border-b-2 border-gray-100">
                          <div className="flex items-center ">
                            <div
                              ...
                              className=" flex justify-center items-center h-8 w-8 bg-[#F6F7FB] rounded-full cursor-pointer hover:ring-[#3577F0]  hover:ring-2  duration-300 ml-4"
                            >
                              <i class="fa-solid fa-xmark text-xs"></i>
                            </div>
                            <Link to="/ProductV1">
                              <img
                                className="h-20 w-20 ml-10 cursor-pointer"
                                src={item.image}
                              ></img>
                            </Link>
                          </div>
                          <Link
                            to="/ProductV1"
                            className="text-xl w-80 font-semibold text-[#292930] hover:text-[#3577F0] cursor-pointer -ml-28 duration-300 "
                          >
                            {item.name}
                          </Link>
                          <div className="relative">
                            <p className="w-28 absolute -right-20 -top-4 text-gray-500 font-semibold text-xl">
                              <span>$</span>
                              {item.newprice}
                            </p>
                          </div>

                          <div className="flex items-center mr-40 ml-20">
                            <button
                          ...
                          <div className="relative">
                            <p className="w-28 absolute -right-6 -top-4 text-gray-500 font-semibold text-xl ">
                              ${item.rate}
                            </p>
                          </div>
                        </div>
            ...
            <div className="grid grid-cols-2 pt-10 gap-10">
              <div className="flex items-end ">
                <div className="border-b-2 border-gray-100 pb-5 w-[100%]">
                  <input
                    className="w-[100%] placeholder:text-sm placeholder:text-gray-500"
                    type="text"
                  ...
                  <div>
                    <ul className="leading-7">
                      <li>
                        <input
                          type="radio"
                          checked={selectRadio === "Free Shippping"}
                          onChange={() => setselectradio("Free Shippping")}
                        />
                      ...
                      <li>
                        <input
                          type="radio"
                          checked={selectRadio === "Local: $35.00"}
                          onChange={() => setselectradio("Local: $35.00")}
                        />
                      ...
                      <li>
                        <input
                          type="radio"
                          checked={selectRadio === "Flat rate: $12.00"}
                          onChange={() => setselectradio("Flat rate: $12.00")}
                        />

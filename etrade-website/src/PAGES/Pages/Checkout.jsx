  ...
  return (
    <>
      <div>
        ...
        <section className="BILLING-FORM px-24 my-[80px]">
          <div className="grid grid-cols-2 gap-10">
            <div className="LEFT-PART">
              <div className="dropdown-1">
                <div className="flex  items-center py-4 px-7 bg-[#F6F7FB] rounded-md mb-5">
                  ...
                  <div
                    ...
                    className="font-medium text-gray-700 hover:text-[#3577F0] duration-300 ml-1 "
                    href=""
                  >
                    Click here to login{" "}
                    <span className="text-[#777777] text-xl">
                ...
                {isOpen1 && (
                  <div className="border rounded-xl p-7 mb-5">
                    ...
                    <div className="relative text-gray-500 mb-8">
                      ...
                      <input
                        type="text"
                        className="w-full  border border-gray-300  px-7 py-4 rounded-md font-normal outline-none "
                      />
                    </div>
                    <div className="relative text-gray-500 mb-8">
                      <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                    ...
                    <div className="BUTTON">
                      <a
                        href=""
                        className='relative px-10 py-4 bg-[#3577F0] text-white font-bold rounded-md 
                                            before:absolute
                                            before:content-[""]
                                            before:bg-[#3577F0]
                                            before:top-0
                ...
                {isOpen2 && (
                  <div className="border rounded-xl p-7 mb-5 ">
                    ...
                    <div className="flex items-center text-gray-500 mb-4">
                      <input
                        type="text"
                        className=" border border-gray-300  px-7 py-4 rounded-md font-normal outline-none mr-4"
              ...
              <div className="BILLING-DETAILS">
                <h1 className="font-medium text-2xl text-[#292930] mb-10">
                  Billing details
                </h1>
                ...
                <div className="grid grid-cols-2 gap-8 mb-8">
                  <div className="relative text-gray-500  ">
                    <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                      First Name<span className="text-[#E76458] ml-1">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="relative text-gray-500 ">
                    <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                      Last Name<span className="text-[#E76458] ml-1">*</span>
                    </label>
                    <input
                      type="text"
                      className="w-full border border-gray-300  px-10 py-5 rounded-md font-normal outline-none"
                ...
                <div className="relative text-gray-500  mb-8">
                  <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                    Country/ Region{" "}
                    <span className="text-[#E76458] ml-1">*</span>
                  </label>
                  <div className="border border-gray-300  rounded-md font-normal ">
                    <select
                      name=""
                      id=""
                      className="w-full  px-10 py-5 outline-none border-r-[40px] border-white rounded-md"
                    >
                ...
                <div className="relative text-gray-500  mb-8">
                  <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                    Town/ City <span className="text-[#E76458] ml-1">*</span>
                  </label>
                  <input
                    type="text"
                    className="w-full  border border-gray-300  px-10 py-5 rounded-md font-normal outline-none"
                ...
                <div className="relative text-gray-500  mb-8">
                  <label className="absolute -top-3 left-7 bg-white px-2 font-semibold text-sm">
                    Email Address <span className="text-[#E76458] ml-1">*</span>
                  </label>
                  <input
                    type="text"
                    className="w-full  border border-gray-300  px-10 py-5 rounded-md font-normal outline-none"
                ...
                <div className="flex items-center  mb-8">
                  ...
                  <span className="ml-3 text-base cursor-pointer">
                    Create an account
                  </span>
                </div>
                ...
                <div className="dropdown-3">
                  ...
                  >
                    <h1 className="font-medium text-2xl text-[#292930] cursor-pointer">
                  ...
                  <div className="relative text-gray-500 ">
                    ...
                    <textarea
                      className="resize-none border w-full border-gray-300 rounded-md font-normal outline-none
                                    px-9 py-5"
                      cols=""
                      rows="5"
                        ...
                        <ul className="leading-7">
                          <li>
                            <input
                              ...
                              type="radio"
                              checked={selectCateg === "Free Shippping"}
                              onChange={() => setselectCateg("Free Shippping")}
                            />
                          ...
                          <li>
                            <input
                              className="cursor-pointer"
                              type="radio"
                              checked={selectCateg === "Local"}
                              onChange={() => setselectCateg("Local")}
                            />
                          ...
                          <li>
                            <input
                              className="cursor-pointer"
                              type="radio"
                              checked={selectCateg === "Flat rate"}
                              onChange={() => setselectCateg("Flat rate")}
                            />
                            <label className="ml-2 cursor-pointer">
                              Flat rate
                            </label>
                ...
                <div className="mt-8">
                  <div className="border-b-2 py-4">
                    <input
                      className="h-4 w-4"
                      type="radio"
                      checked={selecttransfer === "Direct bank transfer"}
                      onChange={() => setselectTransfer("Direct bank transfer")}
                    />
                    <label className="ml-3 text-xl font-semibold">
                      Direct bank transfer
                    </label>
                    <p className="text-gray-500 ml-7 leading-8 tracking-wide mt-5">
                  ...
                  <div className="border-b-2 py-4">
                    <input
                      className="h-4 w-4"
                      type="radio"
                      checked={selecttransfer === "Cash on delivery"}
                      onChange={() => setselectTransfer("Cash on delivery")}
                    />
                    <label className="ml-3 text-xl font-semibold">
                      Cash on delivery
                    </label>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <input
                          className="h-4 w-4"
                          type="radio"
                          checked={selecttransfer === "Paypal"}
                          onChange={() => setselectTransfer("Paypal")}
                        />
                        <label className="ml-3 text-xl font-semibold">
                          Paypal
                        </label>
                      ...
                      <img
                        src="../src/assets/pages/checkout/asset 2.png"
                        alt=""
                      />
                    </div>
                    <p className="text-gray-500 ml-7 leading-8 tracking-wide mt-5">

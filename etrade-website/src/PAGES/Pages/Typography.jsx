  ...
  return (
    <>
      <div>
        ...
        <section className="px-24 my-[100px]">
          <div className="grid grid-cols-2 text-[#292930] font-semibold ">
            <div className="mr-[15px]">
              <h1 className="text-[46px] mb-[30px]">
                h1 - A Visual Type Scale
              </h1>
              <h2 className="text-[36px] mb-[30px]">
              ...
              <h5 className="text-[20px] mb-[30px]">
                h5 - A Visual Type Scale
              </h5>
              <h6 className="text-[18px] mb-[30px]">
                h6 - A Visual Type Scale
              </h6>
              <div className="text-gray-500 font-normal">
                <p className="text-base mb-[30px]">
                  B1 - Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Dicta minima, provident quos amet non hic animi. Natus dolorum
                  reprehenderit debitis voluptatem magnam beatae itaque dicta

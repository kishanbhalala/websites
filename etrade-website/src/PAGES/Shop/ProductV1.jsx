    ...
    <>
      <div>
        ...
        <section className="IMAGES-AND-DISCRIPTION  bg-[#F9F3F0]">
          <div className="grid grid-cols-2 gap-16 py-[100px] px-24 ">
            <div className="main-div-photos grid grid-cols-2 gap-5">
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 2.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 3.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 4.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 5.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
              ...
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 6.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 7.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 8.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 9.png"
                alt=""
              />
              <img
                className="rounded-md bg-cover"
                src="./src/assets/shop/p1/asset 10.png"
                alt=""
              />
            </div>
                  ...
                  <div className="flex items-center">
                    <div className="mx-5">
                      <Link
                        to="/Cart"
                        href="#"
                        className='relative z-10 font-bold bg-[#3577F0] text-white px-32 py-5 rounded-md 
                                                before:absolute
                                                before:content-[""]
                                                before:px-32
                                                before:py-5
                ...
                <div className="flex">
                  <div className="mr-10">
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img
                        className="h-8"
                        src="./src/assets/shop/p1/asset 11.png"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="mr-10">
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img
                        className="h-8"
                        src="./src/assets/shop/p1/asset 12.png"
                        alt=""
                      />
                    </div>
                    <h1 className="font-semibold text-xl text-[#292930]">
                  ...
                  <div>
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img
                        className="h-8"
                        src="./src/assets/shop/p1/asset 13.png"
                        alt=""
                      />
                    </div>
                    <h1 className="font-semibold text-xl text-[#292930]">

    ...
    <>
      <div>
        ...
        <section className="sticky top-[730px]">
          <a href="#top-scroll" className="absolute -bottom-40 right-10">
            <i class="fa-solid fa-arrow-up bg-[#3577F0] p-4 rounded-md text-white"></i>
          </a>
        </section>

        <section className="my-[100px] px-24">
            ...
            <div>
              <div className="border-[2px] border-gray-300 rounded-md inline-block">
                ...
                >
                  ...
                  <option className="text-lg" value="Beauty">
                    Beauty
                  </option>
                </select>
              </div>
                            ...
                            <div className=" absolute left-8 -bottom-3 group-hover:bottom-10 duration-700 opacity-0 group-hover:opacity-100">
                              <div className="flex justify-center">
                                <div className="flex items-center">
                                  <div
                                    onClick={() => dispatch(wishlistAdd(item))}

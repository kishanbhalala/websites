  ...
  return (
    <>
      <div>
        ...
        <section className="PRODUCTJSON my-[100px] px-24">
          <div className="grid grid-cols-4 gap-20">
            <div>
              <div className="max-w-md mx-auto mb-10">
                ...
                {isOpen1 && (
                  <div className="text-gray-500 leading-10 ml-1">
                    <div>
                      <input
                        type="checkbox"
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Sun Care"}
                        onChange={() => setselectCateg("Sun Care")}
                      />
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Night Care"}
                        onChange={() => setselectCateg("Night Care")}
                      />
                      <label className="ml-3" for="checkbox">
                        Night Care
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Treatments"}
                        onChange={() => setselectCateg("Treatments")}
                      />
                      <label className="ml-3" for="checkbox">
                        Treatments
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Moisturizers"}
                        onChange={() => setselectCateg("Moisturizers")}
                      />
                      <label className="ml-3" for="checkbox">
                        Moisturizers
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Eye Care"}
                        onChange={() => setselectCateg("Eye Care")}
                      />
                      <label className="ml-3" for="checkbox">
                        Eye Care
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Masks"}
                        onChange={() => setselectCateg("Masks")}
                      />
                      <label className="ml-3" for="checkbox">
                        Masks
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "Featured"}
                        onChange={() => setselectCateg("Featured")}
                      />
                      <label className="ml-3" for="checkbox">
                        Featured
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectCateg === "On Sale"}
                        onChange={() => setselectCateg("On Sale")}
                      />
                      <label className="ml-3" for="checkbox">
                        On Sale
                      </label>
                  ...
                  <div className="text-gray-500 leading-10 ml-1">
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectgender === "Men (40)"}
                        onChange={() => setselectGender("Men (40)")}
                      />
                      <label className="ml-3" for="checkbox">
                        Men (40)
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectgender === "Women (56)"}
                        onChange={() => setselectGender("Women (56)")}
                      />
                      <label className="ml-3" for="checkbox">
                        Women (56)
                      </label>
                    ...
                    <div>
                      <input
                        ...
                        class="rounded-checkbox"
                        id="checkbox"
                        checked={selectgender === "Unisex (18)"}
                        onChange={() => setselectGender("Unisex (18)")}
                      />
                      <label className="ml-3" for="checkbox">
                        Unisex (18)
                      </label>
                ...
                {isOpen4 && (
                  <div className="">
                    <ul className="flex items-center mb-3">
                      ...
                      <li className="bg-white rounded-full px-5 py-3 text-gray-500 border-2 m-1 cursor-pointer">
                        S
                      </li>
                      <li className="bg-white rounded-full px-4 py-3 text-gray-500 border-2 m-1 cursor-pointer">
                        M
                      </li>
                      <li className="bg-white rounded-full px-5 py-3 text-gray-500 border-2 m-1 cursor-pointer">
                        L
                ...
                {isOpen5 && (
                  <div>
                    <ul className="flex items-center mb-6">
                      <li className="bg-white rounded-full px-5 py-3 text-gray-500 border-2 border-gray-500 mr-3 cursor-pointer">
                        30
                      </li>
                      <li className="bg-white rounded-full px-4 py-3 text-gray-500 border-2 m-1 cursor-pointer">
                        5000
                    ...
                    <div className="mt-10">
                      ...
                      <h1 className="font-semibold">
                        Price: <span>${value[0]}</span>{" "}
                        <span className="ml-5">${value[1]}</span>
                      </h1>
                    </div>
                  </div>
                )}
            ...
            <div className="grid col-span-3 ">
                        ...
                        <div className="group mb-10">
                          <div className="relative overflow-hidden rounded-[35px]">
                            <div>
                              <div>
                                <img
                                  className="w-96 h-96 object-cover group-hover:scale-110 duration-200"
                                  src={item.image}
                                  alt=""
                                />
                              </div>
                              ...
                              <h1
                                ...
                                style={{
                                  boxShadow:
                                    "0 8px 16px 0 rgba(53,119,240,.3) ",
                                }}
                              >
                                {item.offer}
                              </h1>
                                ...
                                <div className="flex justify-center">
                                  <div className="flex items-center">
                                    ...
                                    >
                                      <div
                                        to="/Cart"
                                        className=" px-7 py-3 z-10 bg-[#ff497c] text-white font-bold rounded-[4px] relative 
                                                                                before:absolute
                                                                                before:contetn-['']
                                                                                before:px-10
                                                                                before:py-5
              ...
              <div>
                <div className="text-center mt-20">
                  <a
                    href="#"
                    className=" px-20 py-5 z-10 bg-[#F6F7FB] text-gray-500 font-bold rounded-[4px] relative 
                                before:absolute
                                before:contetn-['']
                                before:px-10
                                before:py-5

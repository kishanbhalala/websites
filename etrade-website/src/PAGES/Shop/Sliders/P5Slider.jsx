            ...
            <div className="">
                <div className="">
                    <div className=' relative'>
                        <div className='absolute top-[280px] -left-[38px] z-10 hover:scale-110 duration-300 '>
                            <button onClick={handlePrev} className='text-gray-500 '><i class="ri-arrow-left-line  bg-[#F6F7FB] p-4 rounded-md"></i></button>
                        </div>
                        <div className='absolute top-[280px] -right-[38px]  z-10 hover:scale-110 duration-300 '>
                        ...
                        >
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 3.png" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 4.png" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 5.png" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 6.png" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 7.png" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 8.png" alt="" />
                            </div>
                            <div>
                                <img className='rounded-lg w-full' src="./src/assets/shop/p5/asset 2.png" alt="" />
                            </div>
                        </Slider>
                        ...
                        <div className="px-24 py-10">
                            ...
                            >
                                ...
                                <div className="my-2">
                                    <img className='rounded-full w-14 mx-3 hover:ring-2 hover:ring-[#417EF0] duration-300' src="./src/assets/shop/p5/asset 2.png" alt="" />
                                </div>
                            </Slider>
                        </div>
                    </div>

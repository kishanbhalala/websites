        ...
        return (
            <>
                <div className='relative z-10'>
                    <h1 className='absolute px-3 py-1 rounded-md bg-[#417EF0] font-bold text-xs text-white top-8 -right-10 ' style={{ boxShadow: "0 8px 16px 0 rgba(53,119,240,.3) " }}>20% OFF</h1>
                    <div className='absolute top-[490px] -right-10'>

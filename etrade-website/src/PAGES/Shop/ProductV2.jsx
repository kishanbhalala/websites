    ...
    <>
      <div>
        ...
        <section className="IMAGES-AND-DISCRIPTION  bg-[#F9F3F0] ">
          <div className="grid grid-cols-2 gap-32 pt-[80px] px-24">
            <div>
              <P2Slider />
            </div>
                ...
                <div className="flex">
                  <div className="mr-10">
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img
                        className="h-8"
                        src="./src/assets/shop/p2/asset 12.png"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="mr-10">
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img
                        className="h-8"
                        src="./src/assets/shop/p2/asset 13.png"
                        alt=""
                      />
                    </div>
                    <h1 className="font-semibold text-xl text-[#292930]">
                  ...
                  <div>
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img
                        className="h-8"
                        src="./src/assets/shop/p2/asset 14.png"
                        alt=""
                      />
                    </div>
                    <h1 className="font-semibold text-xl text-[#292930]">

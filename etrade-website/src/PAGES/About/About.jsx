  ...
  return (
    <>
      <div>
        ...
        <section className="ABOUT-NAVBAR sticky top-0 z-20 ">
          <AllNavBar />
        </section>

        <section className="ABOUT-NAV-BOTTOM">
          <NavBottom />
        </section>

        <section className="ABOUT-SPEAKER">
            ...
            <div className="3-BOX absolute top-[1100px] pr-48">
              <div className="grid grid-cols-3 gap-7">
                <div className="py-[50px] px-[65px] bg-white rounded-md  hover:outline outline-1 hover:outline-[#3577F0] shadow-lg hover:shadow-none  ">
                  <img
                    className="mb-5 "
                    src="../src/assets/about/asset 4.png"
                    alt=""
                  />
                ...
                <div className="py-[50px] px-[65px] bg-white rounded-md hover:outline outline-1 hover:outline-[#3577F0] shadow-lg hover:shadow-none  ">
                  <img
                    className="mb-5"
                    src="../src/assets/about/asset 5.png"
                    alt=""
                  />
                  <h1 className=" mb-3 text-lg text-[#27272E] font-bold">
                ...
                <div className="py-[50px] px-[65px] bg-white rounded-md hover:outline outline-1 hover:outline-[#3577F0] shadow-lg hover:shadow-none  ">
                  <img
                    className="mb-5"
                    src="../src/assets/about/asset 6.png"
                    alt=""
                  />
                  <h1 className=" mb-3 text-lg text-[#27272E] font-bold">
                    12 Awards Won
          ...
          <div className="OUR-TEAM bg-[#F6F6F6]">
            <div className="px-24">
              <div className="pt-[200px]">
                ...
                <div>
                  <h1 className="text-3xl font-semibold text-[#27272E] mb-10">
                ...
                <Slider ref={(c) => (slider = c)} {...settings}>
                  <div>
                    <div className="rounded-md overflow-hidden max-w-[330px]">
                      <img
                        ...
                        src="../src/assets/about/asset 10.png"
                        alt=""
                      />
                    </div>
                  ...
                  <div>
                    <div className="rounded-md overflow-hidden max-w-[330px]">
                      <img
                        className="bg-cover hover:scale-110 duration-300"
                        src="../src/assets/about/asset 7.png"
                        alt=""
                      />
                    </div>
                  ...
                  <div>
                    <div className="rounded-md overflow-hidden max-w-[330px]">
                      <img
                        className="bg-cover hover:scale-110 duration-300 "
                        src="../src/assets/about/asset 8.png"
                        alt=""
                      />
                    </div>
                  ...
                  <div>
                    <div className="rounded-md overflow-hidden max-w-[330px]">
                      <img
                        className="bg-cover hover:scale-110 duration-300 "
                        src="../src/assets/about/asset 9.png"
                        alt=""
                      />
                    </div>
            ...
            <div className="px-24">
              <div className=" flex items-center mt-[100px] ">
                <div className=" w-[100%] flex justify-start">
                  <img
                    ...
                    src="../src/assets/about/asset 11.png"
                    alt=""
                  />
                </div>
                <div className="">
                  ...
                  <Link to="/Contact">
                    <button className="border px-11 py-5 rounded-md font-semibold mt-8 text-[#27272E]  hover:bg-[#3577F0] hover:text-white duration-500">
                      Get In Touch
                    </button>
                  </Link>
                </div>
              ...
              <div className=" flex items-center my-[100px]">
                ...
                <div className="w-[100%] flex justify-end">
                  <img
                    className="rounded-lg w-[85%]"
                    src="../src/assets/about/asset 12.png"
                    alt=""
                  />
                </div>
              </div>

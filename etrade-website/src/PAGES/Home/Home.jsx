  ...
  return (
    <>
      <div className="Body bg-white" id="top-scroll">
        ...
        <section className="HOME-DROPDOWN py-2 px-24">
          <TopBar />
        </section>

        <section className="HOME-NAVBAR sticky top-2 z-50 px-24">
          <HomeNavBar />
        </section>

        <section className="HERO-SECTION bg-[#F9F3F0] -top-36 h-[1000px] relative overflow-hidden px-24">
          <div className="BACKGROUND-IMG ">
            <img
              className="absolute right-[700px] -bottom-20"
              src="./src/assets/Home/asset 8.png"
              alt=""
            />
            <img
              className="absolute right-[100px] -bottom-12"
              src="./src/assets/Home/asset 9.png"
              alt=""
            />
            <div>
              <Fade bottom>
                <div className="absolute right-[300px] bottom-40">
                  <img
                    className=" "
                    src="./src/assets/Home/asset 6.png"
                    alt=""
                  />
                ...
                <div className="w-40 absolute right-[200px] bottom-32">
                    ...
                    <div className="IMAGES-CIRCLE">
                      <ul className="flex">
                        <li className=" border-2 rounded-full ">
                          <img src="./src/assets/Home/asset 2.png" alt="" />
                        </li>
                        <li className="-ml-5 border-2 rounded-full border-white">
                          <img src="./src/assets/Home/asset 3.png" alt="" />
                        </li>
                        <li className="-ml-5 border-2 rounded-full border-white">
                          <img src="./src/assets/Home/asset 4.png" alt="" />
                        </li>
                        <li className="-ml-5 border-2 rounded-full border-white">
                          <img src="./src/assets/Home/asset 5.png" alt="" />
                        </li>
                      </ul>
                    </div>
        ...
        {/* <section className="sticky bottom-[60px]">
          <a href="#top-scroll" className="absolute right-10">
            <i class="fa-solid fa-arrow-up bg-[#3577F0] p-4 rounded-md text-white"></i>
          </a>
        </section> */}

        <section className="CATEGORIES px-24">
          <Categories />
        </section>

        <section className="HEADPHONES-PHOTO mb-[100px] px-24">
          <div className="relative w-full h-[500px] rounded-md bg-[#F6F7FB] ">
            <img
              className="absolute right-48 -top-24"
              src="./src/assets/home/asset 20.png"
              alt=""
            />
            ...
            <div className="absolute top-16 left-16">
              ...
              <p className="font-bold text-5xl text-[#292930] leading-tight tracking-wide">
                Enhance Your
                <br /> Music Experience
              </p>
              ...
              <div className="relative group z-10 ">
                <a
                  href="#top-scroll"
                  className='absolute px-9 py-4 text-white font-bold rounded-md bg-[#3577F0]  
                                before:content-[""]
                                before:w-[162px]
                                before:[50px]
                                before:bg-[#3577F0]  
        ...
        <section className="JSONDATA Double-slide px-24">
          <DoubleSlide />
        </section>
              ...
              <div className="flex justify-between items-center outline outline-1 outline-gray-200 rounded-md p-7 group hover:shadow-lg hover:shadow-zinc-100 hover:duration-500 hover:outline-none duration-[0.3s]">
                <div className="flex items-center ">
                  ...
                  <div className="pl-8 leading-7">
                    ...
                    <Link
                      to="/ProductV1"
                      className="text-gray-500 font-semibold mb-2 hover:text-[#3577F0] duration-700"
                    >
                      Media Remote
                    </Link>
                ...
                <div>
                  <Link to="/Cart" href="#" className="block mb-6">
        ...
        <section className="HOME-SERVICES px-24">
          <HomeService />
        </section>

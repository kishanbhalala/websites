  ...
  return (
    <>
      <div>
        ...
        <section className="BLOG-GRID px-24 py-[100px] ">
                ...
                <div className="BOX-1 border p-5 rounded-lg relative group">
                  <div className="mb-5 overflow-hidden rounded-md">
                    <Link to="/StandardPost">
                      <img
                        className="rounded-lg bg-cover group-hover:scale-110 duration-500 cursor-pointer"
                        src="./src/assets/blog/blog-grid/asset 3.png"
                        alt=""
                      />
                    </Link>
                    <h2
                      className="absolute top-44 right-10 text-sm text-white cursor-pointer"
                      style={{
                  ...
                  <div className="mb-5">
                    <Link
                      to="/StandardPost"
                      className="text-[#292930] text-xl font-medium hover:text-[#3577F0] cursor-pointer duration-300 inline"
                    >
                ...
                <div className="BOX-2 border p-5 rounded-lg relative group">
                  <div className="mb-5 overflow-hidden rounded-md">
                    <Link to="/StandardPost">
                      <img
                        className="rounded-lg bg-cover group-hover:scale-110 duration-500 cursor-pointer"
                        src="./src/assets/blog/blog-grid/asset 4.png"
                        alt=""
                      />
                    </Link>
                    <h2
                ...
                <div className="BOX-3 border p-5 rounded-lg relative group">
                  <div className="mb-5 overflow-hidden rounded-md">
                    <Link to="/StandardPost">
                      <img
                        className="rounded-lg bg-cover group-hover:scale-110 duration-500 cursor-pointer"
                        src="./src/assets/blog/blog-grid/asset 5.png"
                        alt=""
                      />
                    </Link>
                    <h2

...
const IconSearchAll = ({ isOpen, onClose }) => {
    return (
        <div>
            <div className={`popup ${isOpen ? 'open' : ''}`}>

                <div className="absolute right-36 " onClick={onClose}>
                ...
                <div className='relative'>
                    <div className='absolute -left-[1050px] p-10 rounded-lg bg-white w-[850px]'>
